...
return (
    <header className="w-full bg-[#fffff] text-[#161616] h-16 flex items-center shadow-md fixed top-0 left-0 z-50">
        ...
        {isMenuOpen && (
            <div className="fixed inset-0 bg-white z-40 flex flex-col items-center justify-center md:hidden transition-all">
                <button
                ...
                <nav className="flex start font-medium flex-col gap-6 text-lg">
